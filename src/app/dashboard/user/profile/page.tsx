        ...
        <div className="min-h-screen bg-[#0a0a0a] text-slate-100 p-6">
            ...
            <div className="fixed top-6 right-6 z-[100] space-y-2 w-full max-w-sm">
                {toasts.map((toast) => (
                    <div
                        key={toast.id}
                        className={`flex items-start gap-3 p-4 rounded-2xl border shadow-2xl backdrop-blur-sm animate-in slide-in-from-top-2 fade-in duration-200 ${toast.type === "success"
                ...
                <div className="border border-neutral-800 rounded-3xl bg-neutral-900/20 shadow-xl p-6 sm:p-8 space-y-8">
                    ...
                    <div className="space-y-3 pt-4 border-t border-neutral-800/60">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span
                                className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border ${(user as any).role === "admin"
